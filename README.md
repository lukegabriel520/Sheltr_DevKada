...
- Flood risk equals flood probability plus elevation penalty, then clamped to 0–1. Elevation penalty is 0.0 in the current implementation.
...
| Flip Rate (consistency of predictions) | 0.000 | 0.000 | No flips, or 0 percent, across different sampling resolutions. |
