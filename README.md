...
## Repository overview
- Expo app requests routes and safety data from the Flask API.
- The API selects a route, scores flood exposure, and returns guidance with nearby evacuation centers.
- The data folder contains flood and storm-surge GeoJSON layers and NCR river linework.
